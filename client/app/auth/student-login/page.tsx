      ...
      <div className="w-full max-w-md">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <p className="text-center text-gray-600 dark:text-gray-400 mb-8">
            Sign in to join an exam
          </p>

          <Button
            onClick={handleGoogleSignIn}
            className="w-full h-12 text-lg font-medium flex items-center justify-center gap-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white border-2 border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600"
          >
